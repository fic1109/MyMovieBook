...
<body style="background-image:url('../images/1.jpeg')">
    <div class="wrapper">
        ...
        <p style="color: red">Please fill this form to create an account.</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p style="color: red">Already have an account? <a href="login.php" style="color: yellow">Login here</a>.</p>
        </form>
    </div>    
</body>
</html>